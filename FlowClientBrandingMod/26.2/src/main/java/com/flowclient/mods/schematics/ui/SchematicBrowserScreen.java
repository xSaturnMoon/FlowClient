...
public final class SchematicBrowserScreen extends ModPanelScreen {
    ...
    protected void initPanel() {
        ...
        this.addRenderableWidget(Button.builder(Component.literal(">"), button -> {
            ...
            this.minecraft.gui.setScreen(new SchematicPlacementScreen(this));
        ...
        for (int i = startIndex; i < entries.size(); i++) {
            ...
            this.addRenderableWidget(Button.builder(
                    ...
                    button -> this.minecraft.gui.setScreen(new SchematicActionScreen(this, entry))
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double scrollX, double scrollY) {
        if (this.isHoveringFrame(mouseX, mouseY)) {
            this.scrollOffset = (int) Math.max(0, this.scrollOffset - scrollY);
            this.rebuildWidgets();
            return true;
        }
