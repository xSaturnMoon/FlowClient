...
public abstract class ModPanelScreen extends Screen {
    ...
    protected void drawModDescription(GuiGraphicsExtractor graphics, int frameX, int frameWidth) {
        ...
        graphics.text(this.font, Component.literal(this.modDescriptionKey), textX, titleY, ModPanelTheme.TEXT);
    ...
    protected void drawContentFrame(GuiGraphicsExtractor graphics, int x, int y, int width, int height) {
