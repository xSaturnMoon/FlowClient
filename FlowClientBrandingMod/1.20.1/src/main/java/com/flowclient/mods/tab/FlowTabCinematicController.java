...
public final class FlowTabCinematicController {
    ...
    public static void renderCoverOverlay(GuiGraphics graphics, Minecraft minecraft) {
        FlowTabSettings settings = FlowTabSettings.get();
    ...
    private static void renderSoftVignette(GuiGraphics graphics, int width, int height, float strength) {
