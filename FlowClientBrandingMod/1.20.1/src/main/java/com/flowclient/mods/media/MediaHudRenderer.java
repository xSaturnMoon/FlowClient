...
public final class MediaHudRenderer {
    ...
    private static void drawTextBlock(
        ...
        FlowGfx.text(graphics, font, layout.title(), textX, textY, titleColor, settings.textShadow());
        if (layout.showArtist()) {
            FlowGfx.text(graphics, font, layout.artist(), textX, textY + font.lineHeight + LINE_GAP, subtitleColor, settings.textShadow());
        }
    }
