...
public final class ModPanelTheme {
    ...
    public static void fillBordered(GuiGraphics graphics, int x, int y, int width, int height, int fill, int border) {
        graphics.fill(x + 1, y + 1, x + width - 1, y + height - 1, fill);
        drawBorder(graphics, x, y, width, height, border);
    }

    public static void fillBordered(GuiGraphics graphics, int x, int y, int width, int height, int fill) {
