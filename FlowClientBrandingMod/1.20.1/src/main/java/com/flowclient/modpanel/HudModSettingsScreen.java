...
public final class HudModSettingsScreen extends ModPanelScreen {
    ...
    protected void initPanel() {
        ...
        this.addRenderableWidget(new ModPanelButton(
                ...
                () -> this.minecraft.setScreen(new ModPositionPanelScreen(this))
        ));
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        FlowGfx.text(graphics, this.font, "Position X", labelX, y, 0xFFCCCCCC, false);
        y += 28;
        FlowGfx.text(graphics, this.font, "Position Y", labelX, y, 0xFFCCCCCC, false);
        y += 28;
        FlowGfx.text(graphics, this.font, "Size", labelX, y, 0xFFCCCCCC, false);
