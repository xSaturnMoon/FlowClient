...
public final class LunarQuestCard extends AbstractWidget {
    ...
    protected void extractWidgetRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.text(font, UiFonts.text("Free Medal Quest"), headX + 18, headY + 2, UiColors.BTN_TEXT);
        ...
        graphics.text(font, UiFonts.text("Earn 1 of 3 cosmetics for a limited time!"), this.getX() + 10, textY, UiColors.TEXT_MUTED);

        this.actionButton.extractContents(graphics, mouseX, mouseY, partialTick);
    }
